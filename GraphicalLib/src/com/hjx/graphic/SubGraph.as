					...
					for each(link in node.getLinks()){
						...
						if(!subGraph.contains(link)){
							if (subGraph.contains(link.startNode)){
								...
								link.fallbackStartPoint.x = subGraph.getX(subGraph)+subGraph.width/2;
								link.fallbackStartPoint.y = subGraph.getY(subGraph)+subGraph.height/2;
							...
							if (subGraph.contains(link.endNode)){
								...
								link.fallbackEndPoint.x = subGraph.getX(subGraph)+subGraph.width/2;
								link.fallbackEndPoint.y = subGraph.getY(subGraph)+subGraph.height/2;
