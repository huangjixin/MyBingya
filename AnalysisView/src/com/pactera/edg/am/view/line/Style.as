package com.pactera.edg.am.view.line
{
    ...
    public class Style extends UIComponent
    {
        ...
        public function simpleEndLR(param1:Point, param2:Point, param3:Line) : void
        {
            ...
            var _loc_6:* = param2.x;
            var _loc_7:* = param2.y;
            param3.graphics.moveTo(_loc_6 - 5, _loc_7 + 5);
            param3.graphics.lineTo(_loc_6 - 5, _loc_7 - 5);
            return;
        }// end function
        ...
        public function complexEndLR(param1:Point, param2:Point, param3:Line) : void
        {
            ...
            var _loc_6:* = param2.x;
            var _loc_7:* = param2.y;
            param3.graphics.moveTo(_loc_6 - 5, _loc_7);
            param3.graphics.lineTo(_loc_6, _loc_7 + 5);
            param3.graphics.moveTo(_loc_6 - 5, _loc_7);
            param3.graphics.lineTo(_loc_6, _loc_7 - 5);
            param3.graphics.moveTo(_loc_6 - 5, _loc_7 + 5);
            param3.graphics.lineTo(_loc_6 - 5, _loc_7 - 5);
            param3.graphics.drawCircle(_loc_6 - 7, _loc_7, 2);
            return;
        }// end function
        ...
        public function simpleStartLR(param1:Point, param2:Point, param3:Line) : void
        {
            ...
            var _loc_6:* = param2.x;
            var _loc_7:* = param2.y;
            param3.graphics.moveTo(_loc_4 + 5, _loc_5 + 5);
            param3.graphics.lineTo(_loc_4 + 5, _loc_5 - 5);
            return;
        }// end function
        ...
        public function complexStartLR(param1:Point, param2:Point, param3:Line) : void
        {
            ...
            var _loc_6:* = param2.x;
            var _loc_7:* = param2.y;
            param3.graphics.moveTo(_loc_4 + 5, _loc_5);
            param3.graphics.lineTo(_loc_4, _loc_5 + 5);
            param3.graphics.moveTo(_loc_4 + 5, _loc_5);
            param3.graphics.lineTo(_loc_4, _loc_5 - 5);
            param3.graphics.moveTo(_loc_4 + 5, _loc_5 + 5);
            param3.graphics.lineTo(_loc_4 + 5, _loc_5 - 5);
            param3.graphics.drawCircle(_loc_4 + 7, _loc_5, 2);
            return;
        }// end function
        ...
        public function paint(param1:Line, param2:Point, param3:Point, param4:int) : void
        {
            ...
            if (this.style == 0)
            {
                param1.graphics.moveTo(_loc_5, _loc_6);
            ...
            else if (this.style == 1)
            {
                ...
                param1.graphics.moveTo(_loc_5, _loc_6);
                this.drawMainLine(param1, param2, param3, param4);
                switch(this.tostyle)
                {
                    case 1:
                    {
        ...
        public function freeDraw(param1:Point, param2:Point, param3:Line) : void
        {
            ...
            while (this.checkIn(_loc_13, param2, _loc_11, _loc_12))
            {
        ...
        private function drawMainLine(param1:Line, param2:Point, param3:Point, param4:int) : void
        {
            var _loc_5:* = param2.x;
            var _loc_6:* = param2.y;
            var _loc_7:* = param3.x;
            ...
            if (param4 == 1)
            {
                if (param1.refFlag)
                {
                    this.drawDashed(param1, param2, new Point(_loc_5 + 10, _loc_6), 5, 5);
                    this.drawDashed(param1, new Point(_loc_5 + 10, _loc_6), new Point(_loc_7 - 10, _loc_8), 5, 5);
                    this.drawDashed(param1, new Point(_loc_7 - 10, _loc_8), new Point(_loc_7, _loc_8), 5, 5);
                }
                else
                {
                    param1.graphics.lineTo(_loc_5 + 10, _loc_6);
                    param1.graphics.lineTo(_loc_7 - 10, _loc_8);
                    param1.graphics.lineTo(_loc_7, _loc_8);
                }
            }
            else if (param4 == 2)
            {
                ...
                {
                    this.drawDashed(param1, param2, new Point(_loc_5 + 10, _loc_6), 5, 5);
                    this.drawDashed(param1, new Point(_loc_5 + 10, _loc_6), new Point(_loc_5 + 10, _loc_6 - 18), 5, 5);
                    this.drawDashed(param1, new Point(_loc_5 + 10, _loc_6 - 18), new Point(_loc_7 - 10, _loc_8 + 18), 5, 5);
                    this.drawDashed(param1, new Point(_loc_7 - 10, _loc_8 + 18), new Point(_loc_7 - 10, _loc_8), 5, 5);
                    this.drawDashed(param1, new Point(_loc_7 - 10, _loc_8), new Point(_loc_7, _loc_8), 5, 5);
                }
                else
                {
                    param1.graphics.lineTo(_loc_5 + 10, _loc_6);
                    param1.graphics.lineTo(_loc_5 + 10, _loc_6 - 18);
                    param1.graphics.lineTo(_loc_7 - 10, _loc_8 + 18);
                    param1.graphics.lineTo(_loc_7 - 10, _loc_8);
                    param1.graphics.lineTo(_loc_7, _loc_8);
                }
            }
        ...
        public function arrowDrawEndLR(param1:Point, param2:Point, param3:Line) : void
        {
            ...
            var _loc_6:* = param2.x;
            var _loc_7:* = param2.y;
            param3.graphics.moveTo(_loc_6, _loc_7);
            param3.graphics.lineTo(_loc_6 - 5, _loc_7 + 5);
            param3.graphics.moveTo(_loc_6, _loc_7);
            param3.graphics.lineTo(_loc_6 - 5, _loc_7 - 5);
            return;
        ...
        public function arrowDrawStartLR(param1:Point, param2:Point, param3:Line) : void
        {
            ...
            var _loc_6:* = param2.x;
            var _loc_7:* = param2.y;
            param3.graphics.moveTo(_loc_4, _loc_5);
            param3.graphics.lineTo(_loc_4 + 5, _loc_5 + 5);
            param3.graphics.moveTo(_loc_4, _loc_5);
            param3.graphics.lineTo(_loc_4 + 5, _loc_5 - 5);
            return;
