package com.pactera.edg.am.utilities
{
	...
	{//BrowserInfo Class
	   ...
	   private var _flashWmode:String ="undefined";
		public function BrowserInfo(browserInfoObj:Object, platformObj:Object, agent:String,flashWmode:String) 
		{//BrowserInfo
		
			if (!browserInfoObj || !platformObj || !agent||!flashWmode)
			{//bail
				return;
			}//bail
		...
		public function get flashWmode():String {return _flashWmode;}
	}//BrowserInfo Class
