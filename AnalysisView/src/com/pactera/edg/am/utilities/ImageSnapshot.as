...
public dynamic class ImageSnapshot
{
     ...
     */
    public static const MAX_BITMAP_DIMENSION:int = 8000;//2880*3;
                                ...
                                smoothing:Boolean = false):BitmapData
    {
        ...
        try
        {
            ...
            trace("[ImageSnapshot]"+scaledWidth+","+scaledHeight);
            data = new BitmapData(scaledWidth, scaledHeight, true, 0x00000000);
            trace("[ImageSnapshot2]"+scaledWidth+","+scaledHeight);
...
//zzg 2011-12-14 抓取图片，返回ByteArray
 public static function captureImageAsByteArray(
                                source:IBitmapDrawable, dpi:Number = 0,
                                encoder:IImageEncoder = null,
                                scaleLimited:Boolean = true):ByteArray
    {
