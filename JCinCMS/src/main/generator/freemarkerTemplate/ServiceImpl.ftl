...
public class ${domainObjectName}ServiceImpl extends BaseServiceImpl<${domainObjectName}, String>
	 ...
	 * 
	 * @see
	 * com.jcin.cms.service.I${domainObjectName}Service#deleteByPrimaryKey((java.lang
	 * .String ))
	 */
	@Override
	@Transactional
	 ...
	 * 
	 * @see
	 * com.jcin.cms.service.I${domainObjectName}Service#insert(com.jcin.cms.domain.
	 * ${domainObjectName})
	 */
	@Override
	@Transactional
...
//		record.setCreatedate(new Date()+"");
	 ...
	 * 
	 * @see
	 * com.jcin.cms.service.I${domainObjectName}Service#select(com.jcin.cms.utils.Page)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.jcin.cms.service.I${domainObjectName}Service#select(com.jcin.cms.domain.${domainObjectName}Criteria)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.jcin.cms.service.I${domainObjectName}Service#selectAll()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.jcin.cms.service.I${domainObjectName}Service#selectByPrimaryKey(java.lang
	 * .String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.jcin.cms.service.I${domainObjectName}Service#update(com.jcin.cms.domain.
	 * ${domainObjectName})
	 */
	@Override
	@Transactional
	 ...
	 * 
	 * @see
	 * com.jcin.cms.service.I${domainObjectName}Service#insertBatch(List)
	 */
	@Override
	@Transactional
	 ...
	 * 
	 * @see
	 * com.jcin.cms.service.I${domainObjectName}Service#deleteBatch(List)
	 */
	@Override
	@Transactional
