...
<script type="text/javascript">
	...
	function exportExcel() {
		...
		var url = "user/exportExcel" + param;
		window.open(url);
	}
	...
	function onfilechange() {
		var options = {
			...
			url : "user/excelToList", // override for form's 'action' attribute 
...
<body class="easyui-layout" data-options="fit:true">
		...
		<table id="tgrid" title="" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th id="usernameFieldTh" data-options="field:'username',align:'left'"
						width="100%">名称</th>
	...
	<form id="updateForm" action="user/edit">
