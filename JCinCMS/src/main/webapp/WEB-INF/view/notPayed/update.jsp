...
<body>
	...
	<form action="update" method="post">
		<table>
			...
			<tr>
				<th>ID：</th>
				<td><input type="hidden" id="material" name="id"
					value="${notPayed.id}" /></td>
			</tr>
			<tr>
				<th>日期：</th>
				<td><input type="date" id="recorddate" name="recorddate"
			...
			<tr>
				...
				<td><input type="text" id="weight" name="weight"
					value="${notPayed.weight}"  /></td>
			</tr>
			<tr>
				<th>单价：</th>
				<td><input type="text" id="price" name="price"
					value="${notPayed.price}"  /></td>
			</tr>
			<tr>
				<th>货款：</th>
				<td><input type="text" id="goodsMoney" name="goodsMoney"
					value="${notPayed.goodsMoney}"  /></td>
			</tr>
			<tr>
				<th></th>
