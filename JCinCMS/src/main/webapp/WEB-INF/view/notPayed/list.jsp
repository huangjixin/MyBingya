...
<meta http-equiv="keywords" content="未付款列表">
<meta http-equiv="description" content="未付款管理">
...
// 		var path = "notPayed/notPayedUpdate?id='" + row[0].id+"'";
...
<body class="easyui-layout" data-options="fit:true">
	...
	<form id="addForm" action="notPayed/notPayedAdd"></form>
	<form id="updateForm" action="notPayed/notPayedUpdate" method="get">
