			...
			<form id="validForm" action="createForm" method="post">
				...
				<table class="tb2">
					<tr>
						...
						<td><input type="text" name="id"  value="${role.id}"
							size="35" class="txt"/></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<th class="tbopt">&nbsp;name:</th>
						<td><input type="text" name="name"  value="${role.name}"
							size="35" class="txt"/></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="createDate"  value="${role.createDate}"
							size="35" class="txt"/></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<th class="tbopt">&nbsp;updateDate:</th>
						<td><input type="text" name="updateDate"  value="${role.updateDate}"
							size="35" class="txt"/></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
