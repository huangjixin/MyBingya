...
<title>authorization管理</title>

<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">
<meta http-equiv="expires" content="0">
<meta http-equiv="keywords" content="user,user list,Authorization列表">
...
<script type="text/javascript">
	...
	function update(){
		...
		window.location.href='<%=basePath%>authorization/edit/'+row[0].id; 
	}
	...
	function show(){
		...
		window.location.href='<%=basePath%>authorization/'+row[0].id; 
	}
	//处理事件的函数
	...
	function exportExcel() {
		window.open('<%=basePath%>authorization/exportExcel');
	}
	...
	<div data-options="region:'center'" title=""
		...
		<div id="toolBar" style="padding: 5px;border: 0px;">
			<input type="button" value="添加" id="btn_Add" name="btn_Add"
				onclick="javascript:window.location.href='authorization/new'" /> 
			<input type="button"
		...
		<table id="tgrid" title="" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th id="parentIdsFieldTh"
						data-options="field:'parentIds',align:'center'" width="100%">parentIds</th>
				</tr>
			</thead>
		</table>

	</div>
	<form id="addForm" action="authorization/new"></form>
	<form id="updateForm" action="authorization/edit"></form>
</body>
</html>
