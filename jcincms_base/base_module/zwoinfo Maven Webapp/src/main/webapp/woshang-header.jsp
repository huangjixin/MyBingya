...
<div id="header" class="globalWidth">
	<div id="header-top">
		<div class="contentWidth" id="header-top-content">
			<div class="left">
	...
	<div id="logo" class="contentWidth">
		<div class="right">
			<div class="div" style="padding-top: 20px;">
				...
				<!-- <script language="Javascript">
					...
					var datelocalday = (datelocalday = "0"
							+ datelocalnow.getDate()).substr(
							datelocalday.length - 2, 2);
		...
		<div class="left">
			<div class="div">
				<a href="${ctx}/"><img alt="智沃科技" src="${ctx}/images/logo.png"></a>
			</div>
			<div class="div">
				<div style="padding-left: 10px;">
					<div style="font-size: 22px;font-weight: bold;padding-bottom: 6px;">专家级的营销网站制作品牌</div>
					<div style="font-size: 14px;color: #333333;">致力华南品牌崛起[专注-用心-热情]</div>
				</div>
			</div>
			<div class="div" style="position: relative;">
				<div style="right: 0;position: absolute;padding-bottom: 30px;">
