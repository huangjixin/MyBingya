...
<html>
<head>
<jsp:include page="woshang-meta.jsp" flush="true"></jsp:include>
...
<body>
	...
	<!-- 图片展示 -->
	<jsp:include page="woshang-swiper.jsp" flush="true"></jsp:include>
	<jsp:include page="woshang-index-content.jsp" flush="true"></jsp:include>
