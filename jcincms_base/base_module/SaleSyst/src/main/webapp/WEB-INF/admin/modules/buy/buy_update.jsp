...
<body>
	<form id="validForm" action="${ctxAdmin}/buy/update/${buy.id}"
		method="post">
		<input name="id" value="${buy.id}" type="hidden" />
		<div class="desc">
			<b>进货信息更新</b>&nbsp;&nbsp;<b style="color: red;">${msg}</b>
		</div>
					...
					<table border="0" cellpadding="3" cellspacing="1" width="100%"
						...
						<tr style="text-align: right; BACKGROUND-COLOR: #F4FAFF; ">
							...
							<td nowrap="nowrap" align="left"><input id="proName"
								name="proName" value="${buy.proName}" readonly="true" /> <input
							...
							<td nowrap="nowrap" align="left"><input id="buyAmount"
								...
								onchange="computeTotalAmount();" />&nbsp;<label for="buyAmount"
								style="color:red;">*</label></td>
						</tr>
						<tr style="text-align: right; BACKGROUND-COLOR: #F4FAFF; ">
							<th>&nbsp;总额：</th>
