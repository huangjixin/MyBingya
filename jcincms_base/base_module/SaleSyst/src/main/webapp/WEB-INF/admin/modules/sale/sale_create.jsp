	...
	function createDataGrid(){
		$('#tgrid').datagrid({
		    ...
		    columns: [[
		        ...
		        { field: 'proId', title: '商品Id', align: 'center',width:80 },
		        { field: 'proName', title: '商品名称', align: 'center',width:80 },
		        { field: 'buyAmount', title: '进货价格', align: 'center',width:80 },
		        { field: 'buyNum', title: '进货数量', align: 'center',width:80 }
		    ]],
		    ...
		    onSelect:function (rowIndex, rowData){
		    	$("#proId").val(rowData.proId);
		    	$("#buyId").val(rowData.id);
...
<body>
	<form id="validForm" action="${ctxAdmin}/sale/create" method="post">
		<div class="desc">
			<b>出货信息添加</b>&nbsp;&nbsp;<b style="color: red;">${msg}</b>
		</div>
					...
					<table border="0" cellpadding="3" cellspacing="1" width="100%"
						...
						<tr style="text-align: right; BACKGROUND-COLOR: #F4FAFF; ">
							...
							<td nowrap="nowrap" align="left"><input id="proName"
								...
								type="hidden" /><input id="buyId" name="buyId" value="${sale.buyId}"
							...
							<td nowrap="nowrap" align="left"><input id="saleAmount"
								...
								onchange="computeTotalAmount();" />&nbsp;<label for="saleAmount"
								style="color:red;">*</label></td>
						</tr>
						<tr style="text-align: right; BACKGROUND-COLOR: #F4FAFF; ">
							<th>&nbsp;总额：</th>
