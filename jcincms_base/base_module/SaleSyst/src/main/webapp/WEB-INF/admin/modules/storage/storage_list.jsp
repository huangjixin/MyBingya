...
<script type="text/javascript">
	...
	function deleteRows(selecedRow) {
		...
		$.ajax({
			cache : true,
			type : "POST",
			url : '${ctxAdmin}/storage/deleteById',
			data : pamameter,
			async : false,
	...
	function create() {
		window.location.href = '${ctxAdmin}/storage/create';
	}
	...
	function update() {
		...
		window.location.href = '${ctxAdmin}/storage/update/' + row[0].id + '';
	}
	...
	function show() {
		...
		window.location.href = '${ctxAdmin}/storage/show/' + row[0].id;
	}
	...
	function exportExcel() {
		window.open('${ctxAdmin}/storage/exportExcel');
	}
...
<body class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center'" title=""
		...
		<div id="toolBar" style="padding: 5px;border: 0px;">
			<shiro:hasPermission name="storage:create">
			...
			<shiro:hasPermission name="storage:update">
				<input type="button" value="更新" onclick="update();" />
			</shiro:hasPermission>
			<shiro:hasPermission name="storage:view">
