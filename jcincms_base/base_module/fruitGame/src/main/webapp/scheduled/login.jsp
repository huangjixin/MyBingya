		...
		<div class="content">
			<form name="form" id="form" action="/scheduled/login" method="post">
				<table>
					...
					<tr>
						<td></td>
						<td><input type="submit" value="登录"><input type="button" value="注册" onclick="window.location.href='register';"><input type="button" value="返回首页" onclick="window.location.href='index';"></td>
						<td></td>
					</tr>
					<tr>
						<td></td>
