...
<title>fruitBetresultHistory更新</title>
</head>
<body>
	<form id="validForm" action="${ctxAdmin}/fruitBetresultHistory/update/${fruitBetresultHistory.id}" method="post">
				<input name="id" value="${fruitBetresultHistory.id}" type="hidden" />
				<div class="desc">
					<b>fruitBetresultHistory信息更新</b>&nbsp;&nbsp;<b style="color: red;">${msg}</b>
				</div>
