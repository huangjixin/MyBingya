...
<html>
<head>
<title>fruitBetresultHistory管理</title>
...
<script type="text/javascript">
	...
	function deleteRows(selecedRow) {
		...
		$.ajax({
			cache : true,
			type : "POST",
			url : '${ctxAdmin}/fruitBetresultHistory/deleteById',
			data : pamameter,
			async : false,
	...
	function create(){
		window.location.href='${ctxAdmin}/fruitBetresultHistory/create'; 
	}
	...
	function update(){
		...
		window.location.href='${ctxAdmin}/fruitBetresultHistory/update/'+row[0].id+''; 
	}
	...
	function show(){
		...
		window.location.href='${ctxAdmin}/fruitBetresultHistory/show/'+row[0].id; 
	}
	...
	function exportExcel() {
		window.open('${ctxAdmin}/fruitBetresultHistory/exportExcel');
	}
...
<body class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center'" title=""
		...
		<div id="toolBar" style="padding: 5px;border: 0px;">
			<shiro:hasPermission name="fruitBetresultHistory:create">
				<input type="button" value="添加" id="btn_Add" name="btn_Add" onclick="create();" /> 
			</shiro:hasPermission>
			<shiro:hasPermission name="fruitBetresultHistory:delete">
				<input type="button" value="删除" onclick="deleteRows();" />
			</shiro:hasPermission>
			<shiro:hasPermission name="fruitBetresultHistory:update">
				<input type="button" value="更新" onclick="update();" /> 
			</shiro:hasPermission>
			<shiro:hasPermission name="fruitBetresultHistory:view">
		...
		<table id="tgrid" title="" class="easyui-datagrid"
			...
			data-options="
								...
								striped : true,
								collapsible : true,
								url: '${ctxAdmin}/fruitBetresultHistory/select',
								loadMsg : '数据装载中......',
								method: 'get',
								singleSelect : false,
								selectOnCheck: true,
