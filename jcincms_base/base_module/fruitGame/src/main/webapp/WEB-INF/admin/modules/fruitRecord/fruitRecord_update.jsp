...
<title>fruitRecord更新</title>
</head>
<body>
	<form id="validForm" action="${ctxAdmin}/fruitRecord/update/${fruitRecord.id}" method="post">
				<input name="id" value="${fruitRecord.id}" type="hidden" />
				<div class="desc">
					<b>fruitRecord信息更新</b>&nbsp;&nbsp;<b style="color: red;">${msg}</b>
				</div>
