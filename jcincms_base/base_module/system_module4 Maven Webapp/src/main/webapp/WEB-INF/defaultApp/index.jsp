...
<link href="${ctx}/css/webmain.css" rel="stylesheet" type="text/css" />
<link href="${ctx}/css/ddsmoothmenu.css" rel="stylesheet"
	type="text/css" />
...
<script type="text/javascript" src="${ctx}/scripts/webtry_roll.js"></script>
<script type="text/javascript" src="${ctx}/scripts/ddsmoothmenu.js"></script>
<script type="text/javascript">
	ddsmoothmenu.init({
...
<body>
	<div id="wrapper">
		<div class="top">
			<img src="${ctx}/images/logo.gif" width="650" height="90"
				alt="上海网聚化工有限公司" />
			<div id="lang">
				<a
		...
		<div id="MainMenu" class="ddsmoothmenu">
			<ul>
				<c:forEach var="channel" items="${list}">
					<li><a href="index.html" title="${channel.name}"><span>${channel.name}</span></a></li>
				</c:forEach>
				<!-- <li><a href="index.html" title="公司主页" id="menu_selected"><span>公司主页</span></a></li>
				<li><a href="single.html" title="关于我们"><span>关于我们</span></a>
				<ul class="menulevel">
		...
		<div id="banner">
			<a href="#"><img src="${ctx}/images/banner01.jpg"
				alt="多年的经营过程中，不断优化货源渠道，使产品价格更具竞争力！" width="950" height="152" /></a> <a
				href="#"><img src="${ctx}/images/banner02.jpg"
				alt="多年的经营过程中，不断优化货源渠道，使产品价格更具竞争力！" width="950" height="152" /></a> <a
				href="#"><img src="${ctx}/images/banner03.jpg"
		...
		<div id="index_main" class="clearfix">
				...
				<div class="index-newproducts">
					<h2>
						<span>暂无信息</span><a href="products.html"><img
							src="${ctx}/images/more.gif" width="32" height="5" alt="产品展示" /></a>
					</h2>
							...
							<ul>
								<li class="clearfix"><a href="news.html"
									title="未来几年北美聚酯纤维需求快速增长"><img
										src="${ctx}/images/index_NewsPic.jpg" alt="未来几年北美聚酯纤维需求快速增长"
								...
								<li><a href="${chan.linkAddr}/${doc.id}" title="${doc.title}"><span>2011/6/11</span>-
										${doc.title}</a></li>
							</ul>
				...
				<div class="index-about">
					<h2>
						<span>关于我们</span><a href="single.html"><img
							src="${ctx}/images/more.gif" width="32" height="5" alt="关于我们" /></a>
					</h2>
					<p>
						<img src="${ctx}/images/index_AboutPic.jpg" alt="关于我们" width="145"
			...
			<div class="index-right">
				...
				<div class="index-jobs">
					<h2>
						<span>招聘信息</span><a href="jobs.html"><img
							src="${ctx}/images/more.gif" width="32" height="5" alt="招聘信息" /></a>
					</h2>
					<ul>
						<li><a href="jobs.html" title="实验室技术人员"><span> -
									实验室技术人员</span></a></li>
						<li><a href="jobs.html" title="文员"><span> - 文员</span></a></li>
						<li><a href="jobs.html" title="销售代表"><span> - 销售代表</span></a></li>
						<li><a href="jobs.html" title="销售主管"><span> - 销售主管</span></a></li>
				...
				<img src="${ctx}/images/tel.gif" width="240" height="59" alt="联系我们" />
			</div>
		</div>
		<div id="copyright">
