...
<meta http-equiv="keywords" content="Test列表">
...
<script type="text/javascript">
	...
	function create(){
		window.location.href='${ctxAdmin}/test/create'; 
	}
	...
	function update(){
		...
		window.location.href='${ctxAdmin}/test/update/'+row[0].id+''; 
	}
	...
	function show(){
		...
		window.location.href='${ctxAdmin}/test/show/'+row[0].id; 
	}
	...
	function exportExcel() {
		window.open('${ctxAdmin}/test/exportExcel');
	}
	...
	<div data-options="region:'center'" title=""
		...
		<div id="toolBar" style="padding: 5px;border: 0px;">
			<input type="button" value="添加" id="btn_Add" name="btn_Add"
				onclick="javascript:window.location.href='${ctxAdmin}/test/create'" /> 
			<input type="button"
