...
<html>
<head>
<title>userOrganization管理</title>

<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">
<meta http-equiv="expires" content="0">
<meta http-equiv="keywords" content="UserOrganization列表">
...
<script type="text/javascript">
	...
	function deleteRows(selecedRow) {
		...
		$.ajax({
			cache : true,
			type : "POST",
			url : '${ctxAdmin}/userOrganization/deleteById',
			data : pamameter,
			async : false,
	...
	function create(){
		window.location.href='${ctxAdmin}/userOrganization/create'; 
	}
	...
	function update(){
		...
		window.location.href='${ctxAdmin}/userOrganization/update/'+row[0].id+''; 
	}
	...
	function show(){
		...
		window.location.href='${ctxAdmin}/userOrganization/show/'+row[0].id; 
	}
	...
	function exportExcel() {
		window.open('${ctxAdmin}/userOrganization/exportExcel');
	}
...
<body class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center'" title=""
		...
		<div id="toolBar" style="padding: 5px;border: 0px;">
			<input type="button" value="添加" id="btn_Add" name="btn_Add"
				onclick="javascript:window.location.href='${ctxAdmin}/userOrganization/create'" /> 
			<input type="button"
		...
		<table id="tgrid" title="" class="easyui-datagrid"
			...
			data-options="
								...
								striped : true,
								collapsible : true,
								url: '${ctxAdmin}/userOrganization/select',
								loadMsg : '数据装载中......',
								method: 'get',
								singleSelect : false,
								selectOnCheck: true,
	...
	<form id="addForm" action="userOrganization/new"></form>
	<form id="updateForm" action="userOrganization/edit"></form>
</body>
</html>
