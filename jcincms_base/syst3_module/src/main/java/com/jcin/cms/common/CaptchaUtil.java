...
public class CaptchaUtil {
	...
	private String sessionId = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	private StringBuffer randomCode;
	
	public CaptchaUtil(String sessionid) {
	...
	private String getRandomString(int num) {
		String seid = getSessionId().substring(getSessionId().length()-4);
		return seid;
	}
...
//		}
	...
	public void setRandomCode(StringBuffer randomCode) {
		this.randomCode = randomCode;
	}
}