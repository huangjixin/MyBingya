...
@Controller
@RequestMapping(value = "${adminPath}/dictionary")
...
//	@RequiresPermissions("dictionary:create")
	...
	public String create(Dictionary dictionary, Model uiModel) {
		...
		return "admin/modules/dictionary/dictionary_create";
	}
...
//	@RequiresPermissions("dictionary:update")
	...
	public String update(@PathVariable("id") String id, Model uiModel) {
		...
		uiModel.addAttribute("dictionary", dictionary);
		return "admin/modules/dictionary/dictionary_update";
	}
...
//	@RequiresPermissions("dictionary:show")
	...
	public String show(@PathVariable("id") String id, Model uiModel) {
		...
		uiModel.addAttribute("dictionary", dictionary);
		return "admin/modules/dictionary/dictionary_show";
	}

//	@RequiresPermissions("dictionary:view")
	@RequestMapping(value = { "", "list" })
	public String list(HttpServletRequest httpServletRequest) {
		return "admin/modules/dictionary/dictionary_list";
	}
