...
public class FrontEndController {
	...
	@RequestMapping(value = "{channels}/{code}/{id}")
	...
	// @RequestMapping(value = "/**/{code}")
	// public String channel(@PathVariable("code") String code,
	// @ModelAttribute Page page, Model uiModel,
	// HttpServletRequest httpServletRequest) {
	// String requestRri = httpServletRequest.getRequestURI();
	//
	...
	// documentCriteria.setOrderByClause("id desc");
	//
	// Page page1 = documentService.select(documentCriteria);
	// uiModel.addAttribute("name", channel.getName());
	// uiModel.addAttribute("page", page1);
	// return "front/channel"; // 此处应该返回栏目二级模板目录。
	// }
	//
	// @RequestMapping(value = "/**/{code}.{id}")
	// public String doc(@PathVariable("code") String code,
