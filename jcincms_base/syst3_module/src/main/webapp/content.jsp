...
<div class="globalWidth" id="content1">
	<div class="contentWidth" style="text-align: center;">
		<div id="content1_div"
			...
			<div style="font-size: 40px;">REVOLUTIONS</div>
		...
		<div class="content_p1">
			<ul>
				<li><img id="p2-1" class="content_p1_img"
					src="${ctx}/images/p2-1.jpg" /></li>
				<li><img id="p2-2" class="content_p1_img"
					src="${ctx}/images/p2-2.jpg" /></li>
				<li><img id="p2-3" class="content_p1_img"
					src="${ctx}/images/p2-3.jpg" /></li>
				<li><img id="p2-4" class="content_p1_img"
...
<div class="globalWidth" id="content2">
	<div class="contentWidth"
		...
		<div id="content2_wap1"
			...
			<ul>
				<li style="margin-top: 10px;">1、与web站、WAP站统一后台，便捷高效</li>
				<li style="margin-top: 10px;">2、一键更新，三网展现，全网营销</li>
				<li style="margin-top: 10px;">3、及时互动，沟通无障，<b>离访聊天</b></li>
			</ul>
		</div>
		<div id="content2_wap2"
			...
			<ul>
				<li style="margin-top: 10px;">1、多终端同步自适应展现</li>
				<li style="margin-top: 10px;">2、实现内容自动回复推送</li>
				<li style="margin-top: 10px;">3、Web页面扫二维码进入微网站</li>
				<li style="margin-top: 10px;">4、随心沟通：一键拨号/定位/转发/互动...</li>
				<li style="margin-top: 10px;">5、无缝对接：微博、微信、QQ...</li>
			</ul>
		</div>
		<div
			style="width: 100%;margin: 0 auto;text-align: center;padding-top: 30px;padding-bottom: 30px;">
			<div style="font-size: 40px;">SERVICES</div>
			<div style="font-size: 30px;">——我们的服务——</div>
			<div style="font-size: 30px;padding-top: 10px;font-weight: bold;">
				<span style="color:#F26721;">全网营销型网站</span>
			</div>
		</div>
		<div>
			<img alt="" src="${ctx}/images/p5-cir1.png"> <img alt=""
				src="${ctx}/images/p5-cir2.png"> <img alt=""
				src="${ctx}/images/p5-cir3.png">
		</div>
...
<div class="globalWidth" id="content3"
	...
	<div class="contentWidth"
		...
		<div
			style="width: 100%;margin: 0 auto;text-align: center;padding-bottom: 40px;">
			<div style="font-size: 80px;">About</div>
			<div style="font-size: 40px;padding-top: 20px;">——关于我们的产品——</div>
		</div>
		<div style="position: relative;height: 400px;overflow: hidden;">
			<img id="p3-1" src="${ctx}/images/p3-1.jpg"
				style="width: 300px;position: absolute;right: -500px;bottom: 0px;" />
			<img id="p3-2" src="${ctx}/images/p3-2.png"
				style="width: 600px;position: absolute;right: -500px;bottom: 20px;" />
			<p id="content3_p"
				style="width: 400px;position: absolute;left: -520px;text-align: left;">				广州智沃大力投资，拥有自主知识产权的营销型网站内容管理系统jcinCMS，经过一系列SEO测试及迭代更新优化，已经做到可以让网站内若干关键字百度自然排名在首页。jcinCMS基于Java技术开发，前端核心架构Html5++facebook bootstrap+CSS3+jQuery，系统适用于个人站长、商业企业、政府机构、教育机构和其它各种单位组织的信息门户网站建设，技术先进、安全稳定、操作便利、SEO友好、注重用户体验的JAVA营销型网站内容管理系统。
			</p>
			<div id="content3_ul"
				style="width: 400px;position: absolute;left: -520px;top:200px;text-align: left;">
				<ul>
					<li>JAVA语言开发 安全、稳定、拓展性强、跨平台</li>
					<li>HTML5/CSS3/Bootstrapt规范设计 兼容性强</li>
					<li>模板引擎强大，便于管理</li>
					<li>自定义SEO参数，搜索优化更自主</li>
					<li>全站静态化，利于搜索引擎收录</li>
					<li>灵活可视化所见即所得文档管理，操作更方便</li>
					<li>灵活的权限控制，网站管理更方便</li>
					<li>首页、栏目、文章、图片、关键字、页面代码等均融入SEO技术</li>
					<li>…………</li>
				</ul>
			</div>
		</div>
...
<div class="globalWidth" id="content4"
	...
	<div class="contentWidth"
		...
		<div
			style="width: 100%;margin: 0 auto;text-align: center;padding-bottom: 40px;">
			<div style="font-size:40px;padding-top: 20px;">如何提升推广效果？<br>——没有告诉你，那是我们的错——</div>
		</div>
		<div style="position: relative;height: 400px;">
			...
			<div style="text-align: left;float: left;">
				<ul>
					<li style="margin-top: 20px;">第一层：有效展现次数少?</li>
					<li style="margin-top: 20px;">第二层：被点击次数更少?</li>
					<li style="margin-top: 20px;">第三层：几乎没流量?</li>
					<li style="margin-top: 20px;">第四层：有流量没咨询?</li>
					<li style="margin-top: 20px;">第五层：有咨询没转化?</li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="globalWidth" id="content5">
	<div class="contentWidth"
		...
		<div
			style="width: 100%;margin: 0 auto;text-align: center;padding-top: 30px;padding-bottom: 30px;">
			<div style="font-size: 40px;">HOW</div>
			<div style="font-size: 30px;padding-top: 10px;font-weight: bold;">
				<span style="color:#F26721;">提供优秀服务的关键</span>
			</div>
		</div>
		<div class="content_p1">
			<ul>
				...
				<li><div style="text-align: center;width: 100%;margin: 0 auto;">
						...
						<div style="height: 20px;"></div>
						<div style="width: 80%;text-align: center;margin: 0 auto;">
							<div>专业营销策划团队，为您量身打造最佳营销网站方案。</div>
						</div>
					</div></li>
				<li><div style="text-align: center;width: 100%;margin: 0 auto;">
				...
				<li>
					<div style="text-align: center;width: 100%;margin: 0 auto;">
						...
						<div style="height: 20px;"></div>
						<div style="width: 80%;text-align: center;margin: 0 auto;">
							<div>CSS3、HTML5、JS实现页面动态展示及交互。</div>
						</div>
					</div>
				</li>
				<li><div
						...
						<div style="height: 20px;"></div>
						<div style="width: 80%;text-align: center;margin: 0 auto;">
							<div>管理端和前端页面数据对接，SEO角度代码优化及结构调整。</div>
						</div>
					</div></li>
				<li><div
						style="text-align: center;width: 100%;margin: 0 auto;padding-top: 20px;">
						...
						<div style="height: 20px;"></div>
						<div style="width: 80%;text-align: center;margin: 0 auto;">
							<div>User Acceptance Test（用户验收测试），做到万无一失。</div>
						</div>
					</div></li>
				<li><div
						style="text-align: center;width: 100%;margin: 0 auto;padding-top: 20px;">
...
<div class="globalWidth" id="content6"
	...
	<div class="contentWidth"
		...
		<div
			style="width: 100%;margin: 0 auto;text-align: center;padding-bottom: 40px;">
			<div style="font-size: 80px;">WHY US?</div>
			<div style="font-size: 40px;padding-top: 20px;">我们的优势</div>
		</div>
		<div class="content_p1">
			<ul id="content6_ul" style="height: 0px;">
				<li><div style="text-align: center;width: 100%;margin: 0 auto;">
						<h2>解决五大弊端</h2>
						<div style="height: 20px;"></div>
						<div class="content6_div"
							style="height: 0px;width: 80%;background-color: #455DC2;text-align: center;margin: 0 auto;overflow: hidden;">
							<div style="padding-top: 30px;">无&nbsp思&nbsp路</div>
							<div style="padding-top: 15px;">无&nbsp系&nbsp统</div>
							<div style="padding-top: 15px;">无&nbsp效&nbsp果</div>
							<div style="padding-top: 15px;">无&nbsp落&nbsp地</div>
							<div style="padding-top: 15px;">无&nbsp方&nbsp法</div>
						</div>
					</div></li>
				<li><div style="text-align: center;width: 100%;margin: 0 auto;">
						<h2>七大诊断纬度</h2>
						...
						<div class="content6_div"
							...
							<div style="padding-top: 15px;">企业移动建站系统</div>
							<div style="padding-top: 15px;">企业网销SEO系统</div>
							<div style="padding-top: 15px;">企业新媒体系统</div>
							<div style="padding-top: 15px;">企业互联网思维</div>
							<div style="padding-top: 15px;">企业SEM建设系统</div>
						</div>
					</div></li>
				<li><div style="text-align: center;width: 100%;margin: 0 auto;">
						<h2>四大落地系统</h2>
						...
						<div class="content6_div"
							...
							<div style="padding-top: 15px;">全网建设与优化系统</div>
							<div style="padding-top: 15px;">定制服务系统</div>
						</div>
					</div></li>
				<li>
					<div style="text-align: center;width: 100%;margin: 0 auto;">
						...
						<div class="content6_div"
							...
							<div style="padding-top: 30px;">最&nbsp实&nbsp战</div>
							<div style="padding-top: 15px;">最&nbsp精&nbsp准</div>
							<div style="padding-top: 15px;">最&nbsp全&nbsp面</div>
							<div style="padding-top: 15px;">最&nbsp超&nbsp值</div>
						</div>
					</div>
				</li>
			</ul>
...
<div class="globalWidth" id="content7">
	<div class="contentWidth" style="text-align: center;">
		<div
			style="width: 100%;margin: 0 auto;text-align: center;padding-top: 30px;padding-bottom: 30px;">
			<a href="${ctx}/channel/news"><div style="font-size: 40px;">News</div>
				<div style="font-size: 30px;">了解最新动态，汇总行业舆论前沿</div></a>
		</div>
		<div style="text-align: left;">
			<div class="container">
				<ul class="tabs">
					<li class="active"><a href="#tab1">新闻中心</a></li>
					<li><a href="#tab2">网络营销学院</a></li>
				</ul>
