...
<c:choose>
	<c:when test="${channel!=null}">
		<c:choose>
			<c:when
				test="${channel.descrition!=null && channel.descrition!=''}">
		...
		<c:choose>
			<c:when test="${channel.keyword!=null && channel.keyword!=''}">
	...
	<c:when test="${document!=null}">
		<c:choose>
			<c:when
				test="${document.description!=null && document.description!=''}">
		...
		<c:choose>
			<c:when test="${document.keyword!=null && document.keyword!=''}">
