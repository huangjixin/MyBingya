...
<title>properties添加</title>
</head>
<body>
	<form id="validForm" action="${ctxAdmin}/properties/create" method="post">
				<div class="desc">
					<b>properties信息添加</b>&nbsp;&nbsp;<b style="color: red;">${msg}</b>
				</div>
				...
				<table class="table">
					...
					<tr>
						...
						<td  style="text-align: left;" colspan="6"><input type="submit" value="保存" />&nbsp;&nbsp;<input type="reset" value="重置" />&nbsp;&nbsp;<input type="button" value="清空" onclick="clearForm();" />&nbsp;&nbsp;<input type="button" value="返回" onclick="javascript:window.location.href='${ctxAdmin}/properties'"/></td>
					</tr>
				</table>	
		</form>		
</body>
