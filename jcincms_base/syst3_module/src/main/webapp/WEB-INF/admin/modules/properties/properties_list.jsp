...
<script type="text/javascript">
	...
	function createDataGrid(){
		$('#tgrid').datagrid({
			...
			striped : true,
			collapsible : true,
			url: '${ctxAdmin}/properties/select',
			loadMsg : '数据装载中......',
			method: 'get',
			singleSelect : false,
			selectOnCheck: true,
	...
	function deleteRows(selecedRow) {
		...
		$.ajax({
			cache : true,
			type : "POST",
			url : '${ctxAdmin}/properties/deleteById',
			data : pamameter,
			async : false,
	...
	function create(){
		window.location.href='${ctxAdmin}/properties/create'; 
	}
	...
	function update(){
		...
		window.location.href='${ctxAdmin}/properties/update/'+row[0].id+''; 
	}
	...
	function show(){
		...
		window.location.href='${ctxAdmin}/properties/show/'+row[0].id; 
	}
	...
	function exportExcel() {
		window.open('${ctxAdmin}/properties/exportExcel');
	}
...
<body class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center'" title=""
		...
		<div id="toolBar" style="padding: 5px;border: 0px;">
			<shiro:hasPermission name="properties:create">
				<input type="button" value="添加" id="btn_Add" name="btn_Add" onclick="create();" /> 
			</shiro:hasPermission>
			<shiro:hasPermission name="properties:delete">
				<input type="button" value="删除" onclick="deleteRows();" />
			</shiro:hasPermission>
			<shiro:hasPermission name="properties:update">
				<input type="button" value="查看" onclick="update();" /> 
			</shiro:hasPermission>
			<!--<shiro:hasPermission name="properties:view">
