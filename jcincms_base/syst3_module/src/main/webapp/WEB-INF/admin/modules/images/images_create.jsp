				...
				<table class="table">
					...
					<td>
						<input id="site" name="site" 
								value="${images.site}"/>
									&nbsp;<label for="site" style="color:red;">*</label></td>
					</tr>
					<tr>
					<th>&nbsp;proProduct_id：</th>
					<td>
					...
					<td>
						<input id="position" name="position" 
								value="${images.position}"/>
									&nbsp;<label for="position" style="color:red;">*</label></td>
					</tr>
					<tr>
					<th>&nbsp;sortid：</th>
					<td>
					...
					<td>
						<input id="ismasterpic" name="ismasterpic" 
								value="${images.ismasterpic}"/>
									&nbsp;<label for="ismasterpic" style="color:red;">*</label></td>
					</tr>
					<tr>
					<th>&nbsp;createDate：</th>
					<td>
					...
					<tr>
						...
						<td  style="text-align: left;" colspan="6"><input type="submit" value="保存" />&nbsp;&nbsp;<input type="reset" value="重置" />&nbsp;&nbsp;<input type="button" value="清空" onclick="clearForm();" />&nbsp;&nbsp;<input type="button" value="返回" onclick="javascript:window.location.href='${ctxAdmin}/images'"/></td>
					</tr>
				</table>	
		</form>		
</body>
