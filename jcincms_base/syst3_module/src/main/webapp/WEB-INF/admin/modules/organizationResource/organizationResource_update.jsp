...
<body>
	<form:form id="validForm" action="${ctxAdmin}/organizationResource/update/${organizationResource.id}" method="post" commandName="organizationResource">
				<input name="id" value="${organizationResource.id}" type="hidden" />
				<div class="desc">
