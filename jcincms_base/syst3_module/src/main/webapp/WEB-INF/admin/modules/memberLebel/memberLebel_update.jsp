	...
	<form id="validForm" action="${ctxAdmin}/memberLebel/update/${memberLebel.id}" method="post">
				...
				<table class="table">
					...
					<tr>
						...
						<td  style="text-align: left;" colspan="6"><input type="submit" value="保存" />&nbsp;&nbsp;<input type="reset" value="重置" />&nbsp;&nbsp;<input type="button" value="清空" onclick="clearForm();" />&nbsp;&nbsp;<input type="button" value="返回" onclick="javascript:window.location.href='${ctxAdmin}/memberLebel'"/></td>
					</tr>
				</table>	
		</form>		
</body>
