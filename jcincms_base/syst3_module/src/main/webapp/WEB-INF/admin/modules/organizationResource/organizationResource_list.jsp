...
<html>
<head>
<title>organizationResource管理</title>

<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">
<meta http-equiv="expires" content="0">
<meta http-equiv="keywords" content="OrganizationResource列表">
...
<script type="text/javascript">
	...
	function deleteRows(selecedRow) {
		...
		$.ajax({
			cache : true,
			type : "POST",
			url : '${ctxAdmin}/organizationResource/deleteById',
			data : pamameter,
			async : false,
	...
	function create(){
		window.location.href='${ctxAdmin}/organizationResource/create'; 
	}
	...
	function update(){
		...
		window.location.href='${ctxAdmin}/organizationResource/update/'+row[0].id+''; 
	}
	...
	function show(){
		...
		window.location.href='${ctxAdmin}/organizationResource/show/'+row[0].id; 
	}
	...
	function search() {
		...
		if ($("organizationIdInput").val() != "") {
			queryParams.organizationId = $("#organizationIdInput").val();
		}
	...
	function exportExcel() {
		window.open('${ctxAdmin}/organizationResource/exportExcel');
	}
...
<body class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center'" title=""
		...
		<div id="toolBar" style="padding: 5px;border: 0px;">
			<input type="button" value="添加" id="btn_Add" name="btn_Add"
				onclick="javascript:window.location.href='${ctxAdmin}/organizationResource/create'" /> 
			<input type="button"
		...
		<div style="padding: 5px;border: 0px;">
			...
			<input  id="organizationIdInput" onkeydown="onKeyEnter(event.keyCode||event.which);">&nbsp;&nbsp;
		...
		<table id="tgrid" title="" class="easyui-datagrid"
			...
			data-options="
								...
								striped : true,
								collapsible : true,
								url: '${ctxAdmin}/organizationResource/select',
								loadMsg : '数据装载中......',
								method: 'get',
								singleSelect : false,
								selectOnCheck: true,
			...
			<thead>
				<tr>
					...
					<th data-options="field:'organizationId',align:'center'" width="100%">organizationId</th>
	...
	<form id="addForm" action="organizationResource/new"></form>
	<form id="updateForm" action="organizationResource/edit"></form>
</body>
</html>
