	...
	<form id="validForm" action="${ctxAdmin}/category/update/${category.id}" method="post">
				...
				<table class="table">
					...
					<tr>
						...
						<td  style="text-align: left;" colspan="6">&nbsp;&nbsp;<input type="button" value="返回" onclick="javascript:window.location.href='${ctxAdmin}/category'"/></td>
					</tr>
				</table>	
		</form>		
</body>
