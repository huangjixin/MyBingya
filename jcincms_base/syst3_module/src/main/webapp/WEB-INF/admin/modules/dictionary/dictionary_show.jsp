...
<body>
	<form:form id="validForm" commandName="dictionary">
				<div class="desc">
					<b>dictionary信息更新</b>
				</div>
						...
						<td width="100%">
							<table border="0" cellpadding="3" cellspacing="1" width="100%"
								...
								<tr style="text-align: right; BACKGROUND-COLOR: #F4FAFF; ">
									...
									<td  style="text-align: left;" colspan="6"><input type="button" value="返回" onclick="javascript:window.location.href='${ctxAdmin}/dictionary'"/></td>
								</tr>
							</table>
						</td>
					</tr>
