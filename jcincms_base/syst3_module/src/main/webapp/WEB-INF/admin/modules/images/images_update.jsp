...
<html>
<head>
<%@ include file="/WEB-INF/admin/include/js.jsp"%><script
...
<body>
	<form id="validForm" action="${ctxAdmin}/images/update/${images.id}"
		method="post">
		<input name="id" value="${images.id}" type="hidden" />
		<div class="desc">
			<b>商品图片信息更新</b>&nbsp;&nbsp;<b style="color: red;">${msg}</b>
		</div>
	...
	<div id="dlg" class="easyui-dialog" title="文档选择"
		...
		<div style="padding: 5px;border: 0px;">
			...
			<input type="button" value="取消选中" onclick="cancelSelected();" />
		</div>
