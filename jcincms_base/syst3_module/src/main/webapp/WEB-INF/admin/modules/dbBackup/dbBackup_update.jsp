...
<body>
	<form:form id="validForm" action="${ctxAdmin}/dbBackup/update/${dbBackup.id}" method="post" commandName="dbBackup">
				<input name="id" value="${dbBackup.id}" type="hidden" />
				<div class="desc">
					<b>dbBackup信息更新</b>&nbsp;&nbsp;<b>${msg}</b>
				</div>
						...
						<td width="100%">
							<table border="0" cellpadding="3" cellspacing="1" width="100%"
								...
								<tr style="text-align: right; BACKGROUND-COLOR: #F4FAFF; ">
									...
									<td  style="text-align: left;" colspan="6"><input type="submit" value="保存" />&nbsp;&nbsp;<input type="button" value="返回" onclick="javascript:window.location.href='${ctxAdmin}/dbBackup'"/></td>
								</tr>
							</table>
						</td>
					</tr>
