...
<title>voteChoice更新</title>
</head>
<body>
	<form:form id="validForm" action="${ctxAdmin}/voteChoice/update/${voteChoice.id}" method="post" commandName="voteChoice">
				<input name="id" value="${voteChoice.id}" type="hidden" />
				<div class="desc">
					<b>voteChoice信息更新</b>&nbsp;&nbsp;<b style="color: red;">${msg}</b>
				</div>
