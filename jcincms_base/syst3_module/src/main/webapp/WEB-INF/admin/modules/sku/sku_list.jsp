...
<script type="text/javascript">
		...
		$('#tgrid').datagrid({
		    ...
		    columns: [[
		        { field: 'ck', checkbox: true },
		        	...
		        	,
		        		{ field: 'productId',title: 'productId', align: 'center',width:80 }
		        	,
	...
	function create(){
		window.location.href='${ctxAdmin}/sku/create'; 
	}
	...
	function update(){
		...
		window.location.href='${ctxAdmin}/sku/update/'+row[0].id+''; 
	}
	...
	function show(){
		...
		window.location.href='${ctxAdmin}/sku/show/'+row[0].id; 
	}
	...
	function search() {
		...
		if ($("productIdInput").val() != "") {
			queryParams.productId = $("#productIdInput").val();
		}
		if ($("countsInput").val() != "") {
	...
	function exportExcel() {
		window.open('${ctxAdmin}/sku/exportExcel');
	}
...
<body class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center'" title=""
		...
		<div style="padding: 5px;border: 0px;">
			...
			<input  id="productIdInput" onkeydown="onKeyEnter(event.keyCode||event.which);">&nbsp;&nbsp;
			<label>counts:</label>
