...
<script type="text/javascript">
		...
		$('#tgrid').datagrid({
		    ...
		    columns: [[
		        { field: 'ck', checkbox: true },
		        	...
		        	,
		        		{ field: 'parentId',title: 'parentId', align: 'center',width:80 }
		        	,
		        	...
		        	,
		        		{ field: 'isParent',title: 'isParent', align: 'center',width:80 }
	...
	function search() {
		...
		if ($("isParentInput").val() != "") {
			queryParams.isParent = $("#isParentInput").val();
		}
...
<body class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center'" title=""
		...
		<div style="padding: 5px;border: 0px;">
			...
			<input  id="isParentInput" onkeydown="onKeyEnter(event.keyCode||event.which);">&nbsp;&nbsp;
		</div>
		<table id="tgrid">
		</table>
	</div>
