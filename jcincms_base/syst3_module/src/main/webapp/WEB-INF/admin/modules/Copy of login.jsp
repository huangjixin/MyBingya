...
<link href="${ctxA}/css/style.css" rel="stylesheet" type="text/css" />
<script src="${ctxA}/js/cloud.js" type="text/javascript"></script>
<script src="${ctxA}/js/jquery.js" type="text/javascript"></script>
...
<body
	style="background-color:#1c77ac; background-image:url(${ctxA}/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
	<div id="mainBody">
			...
			<div class="loginbox">
				<ul>
					...
					<li><input id="password" name="password" type="password" class="loginpwd"
						value="123456" onclick="JavaScript:this.value=''" /></li>
