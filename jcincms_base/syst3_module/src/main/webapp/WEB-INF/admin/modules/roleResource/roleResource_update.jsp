...
<body>
	<form:form id="validForm" action="${ctxAdmin}/roleResource/update/${roleResource.id}" method="post" commandName="roleResource">
				<input name="id" value="${roleResource.id}" type="hidden" />
				<div class="desc">
					<b>roleResource信息更新</b>&nbsp;&nbsp;<b>${msg}</b>
				</div>
						...
						<td width="100%">
							<table border="0" cellpadding="3" cellspacing="1" width="100%"
								...
								<tr style="text-align: right; BACKGROUND-COLOR: #F4FAFF; ">
									...
									<td  style="text-align: left;" colspan="6"><input type="submit" value="保存" />&nbsp;&nbsp;<input type="button" value="返回" onclick="javascript:window.location.href='${ctxAdmin}/roleResource'"/></td>
								</tr>
							</table>
						</td>
					</tr>
