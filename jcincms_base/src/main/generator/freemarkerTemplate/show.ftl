...
<body>
	<form:form id="validForm" action="createForm" method="post" commandName="${objInst}">
						...
						<td width="100%">
							<table border="0" cellpadding="3" cellspacing="1" width="100%"
								...
								<tr style="text-align: right; BACKGROUND-COLOR: #F4FAFF; font-weight: bold">
									...
									<td  style="text-align: left;" colspan="6">&nbsp;&nbsp;<input type="button" value="返回" onclick="javascript:window.location.href='<%=basePath%>${objInst}'"/></td>
								</tr>
							</table>
						</td>
					</tr>
