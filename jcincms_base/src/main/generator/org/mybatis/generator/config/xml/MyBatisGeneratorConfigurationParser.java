...
import org.mybatis.generator.config.ServiceImplConfiguration;
...
public class MyBatisGeneratorConfigurationParser {
    ...
    private void parseContext(Configuration configuration, Node node) {
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            }/*else if ("serviceImplGenerator".equals(childNode.getNodeName())) { //$NON-NLS-1$
            	parseServiceImpl(context, childNode);
            }*/
        }
    }
    ...
    /*private void parseServiceImpl(Context context, Node node){
    	 ServiceImplConfiguration serviceImplConfiguration = new ServiceImplConfiguration();

         context.setServiceImplConfiguration(serviceImplConfiguration);

         Properties attributes = parseAttributes(node);
         String targetPackage = attributes.getProperty("targetPackage"); //$NON-NLS-1$
         String targetProject = attributes.getProperty("targetProject"); //$NON-NLS-1$

         serviceImplConfiguration.setTargetPackage(targetPackage);
         serviceImplConfiguration.setTargetProject(targetProject);	
         ...
         for (int i = 0; i < nodeList.getLength(); i++) {
             ...
             if ("property".equals(childNode.getNodeName())) { //$NON-NLS-1$
                 parseProperty(serviceImplConfiguration, childNode);
             }
         }
    }*/
