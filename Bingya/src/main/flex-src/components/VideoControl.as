package components
{
	 ...
	 *  @productversion Flex 4
	 */
	public class VideoControl extends SkinnableComponent
	{
		//--------------------------------------------------------------------------
		//
		//  Class constants
		...
		public function set videoDisplay(value:VideoDisplay):void
		{
			...
			_videoDisplay.addEventListener(TimeEvent.CURRENT_TIME_CHANGE, videoDisplay_currentTimeChangeHandler);
			_videoDisplay.addEventListener(LoadEvent.BYTES_LOADED_CHANGE, videoDisplay_bytesLoadedChangeHandler);
			_videoDisplay.addEventListener(MediaPlayerStateChangeEvent.MEDIA_PLAYER_STATE_CHANGE, videoDisplay_mediaPlayerStateChangeHandler);
			_videoDisplay.addEventListener(TimeEvent.DURATION_CHANGE, videoDisplay_durationChangeHandler);
			_videoDisplay.addEventListener(TimeEvent.COMPLETE, dispatchEvent);
			
			// just strictly for binding purposes
			_videoDisplay.addEventListener("sourceChanged", dispatchEvent);
			_videoDisplay.addEventListener("volumeChanged", videoDisplay_volumeChangedHandler);
			...
			{
				_videoDisplay.source = videoDisplayProperties.source;
			...
			{
				_videoDisplay.autoPlay = videoDisplayProperties.autoPlay;
				newVideoProperties = BitFlagUtil.update(newVideoProperties as uint, 
			...
			{
				_videoDisplay.volume = videoDisplayProperties.volume;
				newVideoProperties = BitFlagUtil.update(newVideoProperties as uint, 
			...
			{
				_videoDisplay.autoRewind = videoDisplayProperties.autoRewind;
				newVideoProperties = BitFlagUtil.update(newVideoProperties as uint, 
			...
			{
				_videoDisplay.loop = videoDisplayProperties.loop;
				newVideoProperties = BitFlagUtil.update(newVideoProperties as uint, 
			...
			{
				_videoDisplay.scaleMode = videoDisplayProperties.scaleMode;
				newVideoProperties = BitFlagUtil.update(newVideoProperties as uint, 
			...
			{
				_videoDisplay.muted = videoDisplayProperties.muted;
				newVideoProperties = BitFlagUtil.update(newVideoProperties as uint, 
			...
			{
				_videoDisplay.pauseWhenHidden = videoDisplayProperties.pauseWhenHidden;
				newVideoProperties = BitFlagUtil.update(newVideoProperties as uint, 
			...
			{
				_videoDisplay.autoDisplayFirstFrame = videoDisplayProperties.autoDisplayFirstFrame;
				newVideoProperties = BitFlagUtil.update(newVideoProperties as uint, 
			...
			{
				_videoDisplay.thumbnailSource = videoDisplayProperties.thumbnailSource;
				newVideoProperties = BitFlagUtil.update(newVideoProperties as uint, 
				...
				videoDisplayProperties.playing !== undefined)
			{
				...
				_videoDisplay.autoPlay = false;
				
				_videoDisplay.addEventListener(FlexEvent.UPDATE_COMPLETE, videoDisplay_updateCompleteHandler);
			}
			...
			if (volumeBar)
			{
				volumeBar.value = _videoDisplay.volume;
				volumeBar.muted = _videoDisplay.muted;
			}
			
			if (muteButton)
			{
				muteButton.volume = _videoDisplay.volume;
				muteButton.muted = _videoDisplay.muted;
			}
