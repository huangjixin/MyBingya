package org.un.cava.birdeye.ravis.graphLayout.visual.events
{
	...
	public class VisualNodeEvent extends Event
	{
		...
		public var baseRenderer:BaseRenderer;
		public function VisualNodeEvent(type:String, node:INode= null, ctrlKey:Boolean= false, bubbles:Boolean=false, cancelable:Boolean=false)
		{
